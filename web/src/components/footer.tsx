...
export function FooterMain() {
  return (
    <div id="footer" className="w-full bg-gray-600 text-white py-8 px-4">
      <div className="flex md:flex-row flex-col justify-around gap-5 p-8 border-b border-white/50">
        <div className="flex flex-col gap-4">
          <Logo />
          <p>Empowering farmers with smart technology for <br />
            better yields and sustainable farming.</p>
        </div>
        <div className="flex w-full gap-4 flex-wrap md:flex-nowrap  justify-around">
          <div className="flex flex-col gap-4 justify-start">
            <Label className="text-xl text-primary">Product</Label>
          ...
          <div className="flex flex-col gap-4 justify-start">
            <Label className="text-xl text-primary">Company</Label>
          ...
          <div className="flex flex-col gap-4 justify-start">
            <Label className="text-xl text-primary">Support</Label>
